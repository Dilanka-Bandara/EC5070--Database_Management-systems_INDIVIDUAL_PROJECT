...
<head>
    ...
    <title>Student Settings - EduPortal</title>
                            ...
                            <form method="POST">
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <small class="d-block text-muted">Receive reschedule updates via email</small>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <small class="d-block text-muted">Receive urgent notifications via SMS</small>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="schedule_reminders" id="scheduleReminders" checked>
                                        <label class="form-check-label" for="scheduleReminders">
                                            <i class="fas fa-calendar-check me-2"></i>Schedule Reminders
                                        </label>
                                        <small class="d-block text-muted">Get reminders about upcoming lab sessions</small>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4 fade-in">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-8"><?= htmlspecialchars(safeGet($student, 'Name', 'Not provided')) ?></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-4"><strong>Email:</strong></div>
                                <div class="col-sm-8"><?= htmlspecialchars(safeGet($student, 'Email', 'Not provided')) ?></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-4"><strong>Course:</strong></div>
                                <div class="col-sm-8"><?= htmlspecialchars(safeGet($student, 'Course', 'Not specified')) ?></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-4"><strong>Student ID:</strong></div>
                                <div class="col-sm-8"><?= htmlspecialchars(safeGet($student, 'StudentID', 'Not assigned')) ?></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-4"><strong>Phone:</strong></div>
                                <div class="col-sm-8"><?= htmlspecialchars(safeGet($student, 'Phone', 'Not provided')) ?></div>
                            </div>
                            
                            <div class="mt-3">
                                <a href="student_profile.php" class="btn btn-outline-primary">
                    ...
                    <div class="card fade-in">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4"><strong>Total Requests:</strong></div>
                                <div class="col-sm-8">
                                    <?php
                                    $totalRequests = $pdo->prepare("SELECT COUNT(*) as total FROM RescheduleRequest WHERE StudentID = ?");
                                    $totalRequests->execute([$studentID]);
                                    echo $totalRequests->fetch()['total'];
                                    ?>
                                </div>
                            </div>
                            <div class="row">
